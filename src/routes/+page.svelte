			...
			<div class="card  p-4">
				...
				<div class="p-4 space-y-4">
					...
					<select bind:value={option} name="option" id="option" class="bg-inherit rounded-lg border shadow-md shadow-white">
						<option class="text-white" value="" selected disabled>Select Option</option>
						<option class="text-white" value="python-lab">Python Lab</option>
						<option class="text-white" value="DS-lab">DS Lab</option>
						<option class="text-white" value="general">General</option>
					</select>
				</div>
				<div>
					{#if option == 'python-lab'}
